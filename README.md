...
<div id="leftContent">
  <div id="leftSpacer">
    ...
    <h1><!--?lit$839863111$-->Download history</h1>
  </div>
</div>
 ...
 <g>
  ...
  <div id="searchTerm">
    <label id="prompt" for="searchInput" aria-hidden="true">
      <!--?lit$839863111$-->Search download history
    </label>
...
<div id="mainContainer">
  <managed-footnote managed-by-icon_=""><template shadowrootmode="open"><!----><!--?lit$839863111$--><!--?--></template></managed-footnote>
  <cr-infinite-list id="downloadsList" role="grid" aria-rowcount="31"><template shadowrootmode="open"><!----><slot></slot></template>
  <!----><cr-lazy-list id="list" chunk-size="0" style="--chunk-size: 0;"><template shadowrootmode="open"><!----><div id="container" style="height: 3399.67px;"><slot id="slot"></slot></div></template>
        <!----><!---->
...
<div id="date" role="heading" aria-level="2"><!--?lit$839863111$-->Today</div>
...
<div id="content" focus-row-container="" class="is-active show-progress focus-row-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5Cviraj%5CDownloads%5CREADME.md&amp;scale=1.25x">
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        ...
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="chrome://downloads/" title="README.md" tabindex="0" role="link" class="" hidden=""><!-- No line break
          --><!--?lit$839863111$-->README.md<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="README.md"><!-- No line break
          --><!--?lit$839863111$-->README.md</span>
        <span id="tag"><!--?lit$839863111$--></span>
      </div>
...
<cr-icon><template shadowrootmode="open"><svg id="baseSvg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;" viewBox="0 0 24 24" class="cr-iconset-svg-icon_" role="none">
 <g>
        ...
        <cr-icon-button id="more-actions" iron-icon="cr:more-vert" class="dropdown-trigger" title="More actions" aria-haspopup="menu" focus-row-control="" focus-type="actionMenuButton" role="button" tabindex="0" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
<cr-icon><template shadowrootmode="open"><svg id="baseSvg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;" viewBox="0 0 24 24" class="cr-iconset-svg-icon_" role="none">
 <g>
        ...
        <cr-icon-button id="quick-show-in-folder" class="icon-folder-open" focus-row-control="" focus-type="quickShow" title="Show in folder" aria-label="Show in folder" role="button" tabindex="0" aria-disabled="false" hidden=""><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div></template>
        </cr-icon-button>
        <cr-icon-button id="quick-remove" class="icon-clear" title="Delete from history" aria-label="Delete from history" focus-row-control="" focus-type="quickRemove" role="button" tabindex="0" aria-disabled="false" hidden=""><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div></template>
        </cr-icon-button>
...
<div id="date" role="heading" aria-level="2"><!--?lit$839863111$--></div>
...
<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="https://claude.ai/api/organizations/b9430f12-588f-46b4-acc8-f7fddff9bbe9/conversations/2d98cc48-af75-40cc-90d3-ee95359ffe7f/wiggle/download-file?path=%2Fmnt%2Fuser-data%2Foutputs%2FREADME.md" title="README.md" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$839863111$-->README.md<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="README.md" hidden=""><!-- No line break
          --><!--?lit$839863111$-->README.md</span>
        <span id="tag"><!--?lit$839863111$--></span>
      </div>
      ...
      <div role="gridcell">
        <div id="initiator-origin">
          <!--?lit$839863111$-->From https://claude.ai
        </div>
      </div>
...
<cr-icon><template shadowrootmode="open"><svg id="baseSvg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;" viewBox="0 0 24 24" class="cr-iconset-svg-icon_" role="none">
 <g>
        ...
        <cr-icon-button id="quick-show-in-folder" class="icon-folder-open" focus-row-control="" focus-type="quickShow" title="Show in folder" aria-label="Show in folder" role="button" tabindex="-1" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div></template>
        </cr-icon-button>
...
<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5Cviraj%5CDownloads%5Cnew+icon-3.html&amp;scale=1.25x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="chrome://downloads/" title="new icon-3.html" tabindex="-1" role="link" class=""><!-- No line break
          --><!--?lit$839863111$-->new icon-3.html<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="new icon-3.html" hidden=""><!-- No line break
          --><!--?lit$839863111$-->new icon-3.html</span>
        <span id="tag"><!--?lit$839863111$--></span>
      </div>
...
<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5Cviraj%5CDownloads%5Cnew+icon-2.html&amp;scale=1.25x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="chrome://downloads/" title="new icon-2.html" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$839863111$-->new icon-2.html<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="new icon-2.html" hidden=""><!-- No line break
          --><!--?lit$839863111$-->new icon-2.html</span>
        <span id="tag"><!--?lit$839863111$--></span>
      </div>
...
<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5Cviraj%5CDownloads%5Cnew+icon-1.html&amp;scale=1.25x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="chrome://downloads/" title="new icon-1.html" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$839863111$-->new icon-1.html<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="new icon-1.html" hidden=""><!-- No line break
          --><!--?lit$839863111$-->new icon-1.html</span>
        <span id="tag"><!--?lit$839863111$--></span>
      </div>
...
<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5Cviraj%5CDownloads%5Cicon128+%281%29.png&amp;scale=1.25x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="https://claude.ai/api/organizations/b9430f12-588f-46b4-acc8-f7fddff9bbe9/conversations/2d98cc48-af75-40cc-90d3-ee95359ffe7f/wiggle/download-file?path=%2Fmnt%2Fuser-data%2Foutputs%2Ficons%2Ficon128.png" title="icon128 (1).png" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$839863111$-->icon128 (1).png<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="icon128 (1).png" hidden=""><!-- No line break
          --><!--?lit$839863111$-->icon128 (1).png</span>
        <span id="tag"><!--?lit$839863111$--></span>
      </div>
...
<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5Cviraj%5CDownloads%5Cicon48+%281%29.png&amp;scale=1.25x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="https://claude.ai/api/organizations/b9430f12-588f-46b4-acc8-f7fddff9bbe9/conversations/2d98cc48-af75-40cc-90d3-ee95359ffe7f/wiggle/download-file?path=%2Fmnt%2Fuser-data%2Foutputs%2Ficons%2Ficon48.png" title="icon48 (1).png" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$839863111$-->icon48 (1).png<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="icon48 (1).png" hidden=""><!-- No line break
          --><!--?lit$839863111$-->icon48 (1).png</span>
        <span id="tag"><!--?lit$839863111$--></span>
      </div>
...
<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5Cviraj%5CDownloads%5Cicon16+%281%29.png&amp;scale=1.25x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="https://claude.ai/api/organizations/b9430f12-588f-46b4-acc8-f7fddff9bbe9/conversations/2d98cc48-af75-40cc-90d3-ee95359ffe7f/wiggle/download-file?path=%2Fmnt%2Fuser-data%2Foutputs%2Ficons%2Ficon16.png" title="icon16 (1).png" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$839863111$-->icon16 (1).png<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="icon16 (1).png" hidden=""><!-- No line break
          --><!--?lit$839863111$-->icon16 (1).png</span>
        <span id="tag"><!--?lit$839863111$--></span>
      </div>
...
<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5Cviraj%5CDownloads%5Cicon+image-3.html&amp;scale=1.25x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="chrome://downloads/" title="icon image-3.html" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$839863111$-->icon image-3.html<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="icon image-3.html" hidden=""><!-- No line break
          --><!--?lit$839863111$-->icon image-3.html</span>
        <span id="tag"><!--?lit$839863111$--></span>
      </div>
...
<cr-icon><template shadowrootmode="open"><svg id="baseSvg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;" viewBox="0 0 24 24" class="cr-iconset-svg-icon_" role="none">
 <g>
        ...
        <cr-icon-button id="more-actions" iron-icon="cr:more-vert" class="dropdown-trigger" title="More actions" aria-haspopup="menu" focus-row-control="" focus-type="actionMenuButton" role="button" tabindex="-1" aria-disabled="false" hidden=""><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
<cr-icon><template shadowrootmode="open"><svg id="baseSvg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;" viewBox="0 0 24 24" class="cr-iconset-svg-icon_" role="none">
 <g>
...
<dialog id="dialog" part="dialog" role="application" aria-roledescription="Actions">
  <div id="wrapper" class="item-wrapper" role="menu" tabindex="-1">
    <slot id="contentNode"></slot>
        ...
        <button class="dropdown-item" id="retry" role="menuitem" hidden="">
          Retry
        </button>
        <button class="dropdown-item" id="deep-scan" hidden="" role="menuitem">
          Scan for malware
...
<!--_html_template_end_--></template>
  ...
  <div id="no-downloads" hidden="">
    <div>
      ...
      <span><!--?lit$839863111$-->Files you download appear here</span>
    </div>
  </div>
</div>
...
<cr-toast id="toast"><template shadowrootmode="open"><!----><slot></slot></template>
  ...
  <cr-button aria-label="Press Ctrl+Z to undo" role="button" tabindex="0" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="background"></div>
<slot id="prefixIcon" name="prefix-icon">
</slot>
<span id="content"><slot></slot></span>
